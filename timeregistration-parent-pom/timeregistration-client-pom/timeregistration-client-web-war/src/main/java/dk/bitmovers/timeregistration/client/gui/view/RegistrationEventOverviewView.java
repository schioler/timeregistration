...
@Title("RegistrationEventOverviewView")
@DesignRoot
@SpringView(name = RegistrationEventOverviewView.VIEW_NAME)
public class RegistrationEventOverviewView extends AbstractView<RegistrationEventOverviewView> {

	public static final String VIEW_NAME = "RegistrationEventOverviewView";
	...
	public RegistrationEventOverviewView() {
		super();
		Design.read(this);
	}
...
//			User user = getTimeregistrationSession().getUser();
//
//			List<ViewInfo> menuItems = getDataProvider().getMenuItems(user);
//			menu.fill(getUI().getNavigator(), menuItems);
			isInit = true;
		}
	}
